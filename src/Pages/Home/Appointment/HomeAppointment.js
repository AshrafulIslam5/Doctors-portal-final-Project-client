...
const HomeAppointment = () => {
    return (
        <div className="min-h-screen mt-52">
            <div className="flex flex-col lg:flex-row appointment-bg justify-center items-center">
                ...
                <div className='text-white p-20 md:p-0 md:px-32'>
                    ...
                    <p className="py-6">It is a long established fact that a reader will be distracted by the readable content of a     age when looking at its layout. The point of using Lorem Ipsumis that it has a more-or-less normal distribution of letters,as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page</p>
